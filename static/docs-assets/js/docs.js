...
jQuery(document).ready(function($) {
  ...
  $('#tokenfield-1').tokenfield({
    autocomplete: {
      source: ['#Rock','blue','green','yellow','violet','brown','purple','black','white'],
      delay: 100
    },
  ...
  var engine = new Bloodhound({
    local: [{value: '#Rock'}, {value: 'blue'}, {value: 'green'} , {value: 'yellow'}, {value: 'violet'}, {value: 'brown'}, {value: 'purple'}, {value: 'black'}, {value: 'white'}],
